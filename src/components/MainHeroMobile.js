...
const MainHeroMobile = ({ content }) => {
  ...
  // Tente de lancer la vidéo automatiquement (prise en charge Safari mobile)
  useEffect(() => {
    ...
    >
      <figure className="absolute inset-0 z-0">
        ...
        >
          {landingVideo?.url && (
            <>
              <source src={landingVideo.url.replace(/\.webm$/i, ".mp4")} type="video/mp4" />
              <source src={landingVideo.url} type="video/webm" />
            </>
          )}
        </video>
      </figure>
